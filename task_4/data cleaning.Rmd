...
2015 - columns to include
  1:96
  114:115
2016 - columns to include
  1:106
2017
  1:109
...
```
  ...
  12 (bonkers the board game, not in 2015, ireleveant?)
  66:68 (m&m political question)
  79 (DVD series joke)
2017 - columns to remove
  12 (bonkers the board game, not in 2015, ireleveant?)
  65:69 (m&m political question)
  81 (DVD series joke)
  86 (bag of booberry crunch, not featured in 2016)
  97 (take 5, not featured in 2016)
```{r}
candy2015_raw <- candy2015_raw %>% 
  rename("age" = 1) %>%
  rename("going_out" = 2) %>% 
